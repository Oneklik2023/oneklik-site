...
const ResumeCard = ({Icon, role, date, description, /*description1*/}: Props) => {
  return (
  <div className="mb-6">
    <div className="flex items-start space-x-6 bg-blue-950/20 transition-all duration-300 p-4 sm:p-8 rounded-md">
        ...
        <div className='flex-1'>
          ...
          {/*<p className='text-[#FC9700] font-bold text-sm sm:text-base pt-3 inline-block animate-pulse animate-pulse-slow'>
            {description1}
          </p>*/}
